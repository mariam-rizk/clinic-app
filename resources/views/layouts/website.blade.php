    ...
    <div class="page-wrapper">
        <nav class="navbar navbar-expand-lg navbar-expand-md bg-blue sticky-top">
            <div class="container">
                ...
                @if (Route::has('login'))
                @auth
                    <a href="{{ url('/dashboard') }}" class="btn btn-outline-light navigation--button" type="button">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="btn btn-outline-light navigation--button" type="button">Log in</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="btn btn-outline-light navigation--button" type="button"> Register</a>
                    @endif
                @endauth
            @endif
